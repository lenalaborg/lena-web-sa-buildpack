...
OS_FAMILY=@{image.os.family}
LENA_ROOT=@{lena.root}
LENA_VERSION=@{lena.version}
LENA_HOME=@{lena.home}
LENA_AGENT_PORT=@{lena.agentPort}
LENA_SERVER_TYPE=@{lena.serverType}
LENA_SERVICE_PORT=@{lena.servicePort}
LENA_SERVER_NAME=@{lena.serverName}
LENA_SERVER_HOME=@{lena.serverHome}
LENA_MGR_UDP_PORT=@{lena.manager.udpPort}
LENA_SESSION_2ND_IP=@{lena.session.2ndIp}
LENA_SESSION_2ND_PORT=@{lena.session.2ndServicePort}
LENA_USER=@{lena.user}
#Max Heap Mem Size
LENA_XMX=@{lena.xmx}
