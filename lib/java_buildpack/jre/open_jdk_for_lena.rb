...
module JavaBuildpack
  module Jre
    ...
    class OpenJdkForLena < JavaBuildpack::Component::VersionedDependencyComponent
      ...
      def detect
        ...
        puts "OpenJdkForLena @component_name : #{@component_name}"
        puts "OpenJdkForLena @configuration : #{@configuration}"
        puts "OpenJdkForLena @version : #{@version}"
        puts "OpenJdkForLena @uri : #{@uri}"
        super
      end
